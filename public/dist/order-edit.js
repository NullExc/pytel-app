...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__google_auth__ = __webpack_require__(2);
...
function insertEvent(order, orderId, customer) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__google_auth_js__ = __webpack_require__(2);
...
/* harmony default export */ __webpack_exports__["a"] = ({ setGoogleApi, loadPicker, createPicker, getPhotoUrls });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_google_auth__ = __webpack_require__(2);
...
app.controller('OrderInputCtrl', function ($scope, $http, $filter) {
    ...
    $scope.currentInputDataSale = function (originalState, savedState) {
        ...
        if (originalState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].saleOrdered) {

            if (savedState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].saleObtained) {
                $scope.fillDate(utcDate, "#saleObtained-date", "#saleObtained-time");

            } else if (savedState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].saleLeaved) {
                $scope.fillDate(utcDate, "#saleObtained-date", "#saleObtained-time");
        ...
        if (originalState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].saleObtained) {

            if (savedState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].saleLeaved) {
                $scope.fillDate(utcDate, "#saleLeaved-date", "#saleLeaved-time");
            }
        }
    ...
    $scope.currentInputData = function (originalState, savedState) {
        ...
        if (originalState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].arrived) {

            if (savedState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].working) {
                $scope.fillDate(utcDate, "#start-date", "#start-time");

            } else if (savedState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].done) {
                $scope.fillDate(utcDate, "#start-date", "#start-time");
                utcDate.setUTCMilliseconds(utcDate.getUTCMilliseconds() + 10);
                $scope.fillDate(utcDate, "#end-date", "#end-time");

            } else if (savedState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].pickUp) {
                $scope.fillDate(utcDate, "#start-date", "#start-time");
                utcDate.setUTCMilliseconds(utcDate.getUTCMilliseconds() + 10);
                $scope.fillDate(utcDate, "#end-date", "#end-time");
                utcDate.setUTCMilliseconds(utcDate.getUTCMilliseconds() + 10);
        ...
        if (originalState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].working) {

            if (savedState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].done) {
                $scope.fillDate(utcDate, "#end-date", "#end-time");
        ...
        if (originalState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].done) {

            if (savedState == __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].pickUp) {
                $scope.fillDate(utcDate, "#pickup-date", "#pickup-time");
            }
        }
    }
    ...
    $scope.stateSelectChange = function () {
        ...
        if ($scope.stateSelect.value === $scope.stateSelect.choices[1]) {
            ...
            $scope.saveState = __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].working;
            ...
            $scope.saveState = __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].done;
            ...
            $scope.saveState = __WEBPACK_IMPORTED_MODULE_0__state_js__["default"].pickUp;
    ...
    var createWorkType = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_5__lib_preloader_js__["a" /* default */].open('Vytvára sa typ práce ...');
    ...
    var createOrderType = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_5__lib_preloader_js__["a" /* default */].open('Vytvára sa typ zákazky ...');
    ...
    var createFacility = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_5__lib_preloader_js__["a" /* default */].open('Vytvára sa príslušenstvo ...');
    ...
    $(document).ready(function () {
        ...
        $('#load-photo').click(function () {
            ...
            if (gapi && gapi.auth2.getAuthInstance() && gapi.auth2.getAuthInstance().isSignedIn.get()) {
                ...
                __WEBPACK_IMPORTED_MODULE_4__lib_picker_js__["a" /* default */].setGoogleApi(gapi, gapi.auth2.getAuthInstance().currentUser.get().getAuthResponse().access_token);
