...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_calendar_js__ = __webpack_require__(12);
...
app.controller('OrdersCtrl', function ($scope, $http, $filter) {
    ...
    if ($scope.userSettings.orders.stateType == __WEBPACK_IMPORTED_MODULE_2__state__["default"].arrived) {
        $scope.typeSelect.value = $scope.typeSelect.choices[1];

    } else if ($scope.userSettings.orders.stateType == __WEBPACK_IMPORTED_MODULE_2__state__["default"].working) {
        $scope.typeSelect.value = $scope.typeSelect.choices[2];

    } else if ($scope.userSettings.orders.stateType == __WEBPACK_IMPORTED_MODULE_2__state__["default"].done) {
        $scope.typeSelect.value = $scope.typeSelect.choices[3];

    } else if ($scope.userSettings.orders.stateType == __WEBPACK_IMPORTED_MODULE_2__state__["default"].pickUp) {
        $scope.typeSelect.value = $scope.typeSelect.choices[4];

    } else if ($scope.userSettings.orders.stateType == __WEBPACK_IMPORTED_MODULE_2__state__["default"].all) {
    ...
    $scope.to = __WEBPACK_IMPORTED_MODULE_5_moment___default.a.utc().endOf('day').toDate(); //new Date(now2.getUTCFullYear(), now2.getUTCMonth(), now2.getUTCDate(), 23, 59);
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery__(document).ready(function () {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery__("#navText").text("Zoznam zákaziek");
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery__("#to-date").val(($scope.to.getDate()) + '.' + ($scope.to.getUTCMonth() + 1) + '.' + $scope.to.getUTCFullYear());
...
app.controller('SaleOrdersCtrl', function ($scope, $http, $filter) {
    ...
    $scope.to = __WEBPACK_IMPORTED_MODULE_5_moment___default.a.utc().endOf('day').toDate(); // new Date(); //new Date(parseInt(dateToParts[2]), parseInt(dateToParts[1] - 1), parseInt(dateToParts[0]), 24, 59);
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery__(document).ready(function () {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery__("#sale-to-date").val(($scope.to.getDate()) + '.' + ($scope.to.getUTCMonth() + 1) + '.' + $scope.to.getUTCFullYear());
